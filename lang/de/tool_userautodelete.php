...
$string['setting_suspended_only'] = 'Nur gesperrte Nutzer';
$string['setting_suspended_only_desc'] = 'Wenn aktiviert, werden nur zurzeit gesperrte Nutzer mit einbezogen. Alle aktiven Nutzer bleiben unangetastet bis diese Option deaktiviert wird. Dies kann nützlich sein wenn der Account-Lebenszyklus extern verwaltet wird (z.B. über SSO) oder eine Sperrphase existiert, bevor der Nutzer abschließend gelöscht werden.';
