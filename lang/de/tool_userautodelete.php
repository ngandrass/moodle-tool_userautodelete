...
$string['log_event_process_abort_manual'] = 'Prozess abgebrochen (manuell)';
$string['log_event_process_abort_workflow_deactivated'] = 'Prozess abgebrochen (Workflow deaktiviert)';
$string['log_event_process_timeout'] = 'Prozess-Zeitüberschreitung';
$string['logs'] = 'Logs';
...
$string['open_online_help'] = 'Onlinehilfe öffnen';
...
$string['privacy:metadata:tool_userautodelete_workflow'] = 'Informationen darüber, wer Nutzerzyklus-Workflows erstellt und zuletzt bearbeitet hat.';
$string['privacy:metadata:tool_userautodelete_workflow:createdby'] = 'Die ID des Nutzers, der den Workflow erstellt hat.';
$string['privacy:metadata:tool_userautodelete_workflow:modifiedby'] = 'Die ID des Nutzers, der den Workflow zuletzt bearbeitet hat.';
...
$string['view_action'] = 'Aktion anzeigen';
$string['view_filter'] = 'Filter anzeigen';
