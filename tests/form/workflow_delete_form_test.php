...
/**
 * Tests for the workflow_delete_form class
 *
 ...
 * Tests for the workflow_delete_form class
 */
final class workflow_delete_form_test extends \advanced_testcase {
    /**
     * Tests that the form definition path can be executed without errors.
     *
     * @covers \tool_userautodelete\form\workflow_delete_form
     *
     * @return void
    ...
    public function test_definition_runs(): void {
        ...
        $form = new workflow_delete_form();
        $this->assertInstanceOf(workflow_delete_form::class, $form, 'Form could not be instantiated');
    }
}
